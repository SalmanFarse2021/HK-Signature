        ...
        <div className="flex items-center gap-3">
          {!showAddForm && (
            <button
              ...
              className="bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 shadow-lg shadow-indigo-500/20 text-white font-medium transition-all duration-200 ease-in-out transform hover:-translate-y-0.5 rounded-xl px-6 py-2.5 flex items-center gap-2"
            >
          ...
          <button onClick={() => load()} className="p-2.5 text-gray-500 hover:text-indigo-600 hover:bg-indigo-50 rounded-xl transition-colors" title="Refresh">
          ...
          <label className="bg-white border border-gray-200 hover:bg-gray-50 hover:border-gray-300 shadow-sm hover:shadow text-gray-700 font-medium transition-all duration-200 rounded-xl px-4 py-2.5 flex items-center gap-2 cursor-pointer" title="Import CSV">
